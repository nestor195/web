...
pdf.Text 10,20,"IMPRECOMP.COM"
pdf.SetFont "Arial","b",8
pdf.Text 10,25,"Servicio Técnico Informático"
pdf.SetFont "Arial","b",8
pdf.Text 10,28.5,"Impresoras - PC - Monitores - Insumos"
pdf.SetFont "Arial","b",8
pdf.Text 10,32,"SUCRE 368 - CENTRO - CORDOBA - TEL. 4271942"
pdf.SetFont "Arial","b",8
pdf.Text 10,35.5,"email: leocaminos@hotmail.com"
...
pdf.SetFont "Arial","b",12
pdf.Text 150,30,"FECHA " & ObRs ("FechaIngreso")
...
pdf.SetFont "Arial","",6 * fuente
pdf.Text 10,199 * fuente,"No será responsable IMPRECOMP.COM por las fallas o visios ocultos no declarados por el cliente (conocidos o no por él) en la orden de reparación. Asimismo se declara no"
pdf.SetFont "Arial","",6 * fuente
