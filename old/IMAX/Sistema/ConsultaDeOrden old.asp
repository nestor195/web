...
<div style="position: absolute; width: 356px; height: 401px; z-index: 2; left: 445px; top: 14px; visibility: hidden" id="Reball">
	<table border="1" bgcolor="#00FFFF" bordercolor="#FF0000" width="359" height="432">
		<tr>
			...
			<%end if%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
			<a href="#" onclick="Reballiedit();">Editar</a>&nbsp;&nbsp; <a href="#" onclick="Reballi();">Cerrar</a></b></font></td>
		</tr>
	</table>
</div>
...
<form method="GET" action="ConsultaDeOrden%20old.asp" webbot-action="--WEBBOT-SELF--">
...
<form method="POST" action="ConsultaDeOrden%20old.asp" webbot-action="--WEBBOT-SELF--">
	<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" height="489">
      <tr>
        <td width="100%" colspan="2" height="21"><font face="Arial"><font size="2">Orden:</font><b><font color="#008000" size="5"><a href="ConsultaDeOrden%20old.asp?Id=<%Response.Write IdOrden - 1%>"><span style="text-decoration: none"><font color="#008000">&lt;</font></span></a></font><font color="#008000" size="4"> <%Response.Write IdOrden%>
    	</font> 
    	<font color="#008000" size="5">
    	<a href="ConsultaDeOrden%20old.asp?Id=<%Response.Write IdOrden + 1%>">
