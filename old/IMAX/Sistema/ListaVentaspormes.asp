...
<body>
<form method="Get" action="ListaVentaspormes.asp" webbot-action="--WEBBOT-SELF--">
...
SQL = "Select * From ConsultaOrdenes Where (Estado = 'Entregado y Cobrado' or Estado = 'Vendido' or Estado = 'Pagado') and FechaEstado between #01/01/09# and #02/01/09# order by FechaEstado"
else
SQL = "Select * From ConsultaOrdenes Where (Estado = 'Entregado y Cobrado' or Estado = 'Vendido' or Estado = 'Pagado') and FechaEstado = #" & FormatMediumDate(Request.QueryString("Fecha")) & "# order by FechaEstado"
end if
ObRs.Open  SQL,ObConn
Total = 0
DO WHILE NOT ObRs.Eof
