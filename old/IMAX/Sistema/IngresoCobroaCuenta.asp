...
%>
<b>Ingreso de Orden<span lang="es"> de Pago A Cuenta</span></b>
<form method="POST" action="IngresoCobroaCuenta.asp" webbot-action="--WEBBOT-SELF--">
	<p>Cliente: <select size="1" name="Cliente">
<%
SET ObConn = Server.CreateObject ("ADODB.Connection")
SET ObRs = Server.CreateObject ("ADODB.RecordSet")
ObConn.Open "Sistema"
SQL = "Select * From Clientes Where Id = " & Request.QueryString ("Cliente")
...
<%
ELSE
'****************************************************************************** Crea Orden con Estado Cobro a Cuenta
SET ObConn = Server.CreateObject ("ADODB.Connection")
SET ObRs = Server.CreateObject ("ADODB.RecordSet")
ObConn.Open "Sistema"
