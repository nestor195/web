...
pdf.SetFont "Arial","b",8
pdf.Text 70,28.5,"LA RIOJA 1014 - CENTRO - CORDOBA"
pdf.SetFont "Arial","b",8
pdf.Text 70,32,"TEL. 4271942"
pdf.SetFont "Arial","b",8
...
pdf.SetFont "Arial","",6.15 * fuente
pdf.Text 10,143 * fuente,"EMISION DE PRESUPUESTO Y PLAZO DE ACEPTACION O DENEGATORIA: Será puesto a disposición del cliente personalmente en el local de IMAX por"
...
pdf.Text 10,157 * fuente,"que IMAX no se hace responsable por la demora incurrida en tal sentido porque depende de la llegada de esos componentes. El diagnóstico se informará dentro"
pdf.SetFont "Arial","",6 * fuente
...
pdf.Text 10,171 * fuente,"de reparación en original. A partir del sexto día IMAX podrá cobrar al cliente la suma de un dólar estadounidenses billete (U$S 3) por día de estadia, en calidad de"
pdf.SetFont "Arial","",5.88 * fuente
pdf.Text 10,175 * fuente,"depósito. Asimismo y en dicho caso, IMAX no será responsable por la pérdida o deterioro que sufra el equipo después de ser notificado. Pasados los 60 días desde"
...
pdf.SetFont "Arial","",6 * fuente
pdf.Text 10,183 * fuente,"transfiriendole todos sus derechos (articulos 2525, 2526 y 3939 del Código Civil) a IMAX para que disponga del mismo."

pdf.SetFont "Arial","",6.15 * fuente
pdf.Text 6,189 * fuente,"4)"
pdf.SetFont "Arial","",6 * fuente
pdf.Text 10,189 * fuente,"Es obligación del cliente tener un Back Up con su información porque IMAX no se hace responsable por la pérdida de softwqare o información. Tampoco es res-"
pdf.SetFont "Arial","",6 * fuente
...
pdf.SetFont "Arial","",6 * fuente
pdf.Text 10,199 * fuente,"No será responsable IMAX por las fallas o visios ocultos no declarados por el cliente (conocidos o no por él) en la orden de reparación. Asimismo se declara no"
pdf.SetFont "Arial","",6 * fuente
pdf.Text 10,203 * fuente,"responsable por robos y/o hurtos producidos mientras el equipo permanece en su taller para su revisación o reparación, a tal fin es obligación del cliente tener un seguro que"
pdf.SetFont "Arial","",6 * fuente
pdf.Text 10,207 * fuente,"cubra su equipo"

pdf.SetFont "Arial","",6.15 * fuente
pdf.Text 6,213 * fuente,"6)"
pdf.SetFont "Arial","",5.85 * fuente
pdf.Text 10,213 * fuente,"GARANTIA: La reparación tiene una garantía de sesenta días corridos a partir de la fecha de retiro del equipo siempre y cuando haya sido retirado dentro de los cinco días hábiles"
pdf.SetFont "Arial","",6 * fuente
pdf.Text 10,217 * fuente,"de notificado conforme a lo expresado en el punto 3. La garantía cubrirá solamente la mano de obra y no los repuestos o partes reemplazadas salvo las que otorque el provee-"
pdf.SetFont "Arial","",6 * fuente
pdf.Text 10,221 * fuente,"dor de dichos repuestos o partes."
