...
<body>
<form method="Get" action="Listasaldosapagar.asp" webbot-action="--WEBBOT-SELF--">
<span lang="es">Cliente/Proveedor</span>:
...
ObConn.Open "Sistema"
SQL = "Select Distinct Cliente From Ordenes Where Estado = 19"
...
SQL = "Select * From ConsultaOrdenes Where (Estado = 'Entregado y Cobrado' or Estado = 'Vendido' or Estado = 'Pagado') and FechaEstado = #" & FormatMediumDate(DATE) & "# order by Id"
else
SQL = "Select * From ConsultaOrdenes Where (Estado = 'Entregado y Cobrado' or Estado = 'Vendido' or Estado = 'Pagado') and FechaEstado = #" & FormatMediumDate(Request.QueryString("Fecha")) & "# order by Id"
end if
ObRs.Open  SQL,ObConn
Total = 0
DO WHILE NOT ObRs.Eof
