...
<body>
<form method="Get" action="ListaVentasConTarjeta.asp" webbot-action="--WEBBOT-SELF--">
...
ObConn.Open "Sistema"
SQL = "Select Distinct FechaEstado From Ordenes Where Estado = 27 Order by FechaEstado desc"
...
SQL = "Select * From ConsultaOrdenes Where (Estado = 'Con Tarjeta') and FechaEstado = #" & FormatMediumDate(DATE) & "# order by Id"
else
SQL = "Select * From ConsultaOrdenes Where (Estado = 'Con Tarjeta') and FechaEstado = #" & FormatMediumDate(Request.QueryString("Fecha")) & "# order by Id"
end if
ObRs.Open  SQL,ObConn
Total = 0
DO WHILE NOT ObRs.Eof
