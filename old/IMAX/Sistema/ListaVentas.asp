...
<body>
<form method="Get" action="ListaVentas.asp" webbot-action="--WEBBOT-SELF--">
...
ObConn.Open "Sistema"
SQL = "Select Distinct FechaEstado From Ordenes Where Estado = 19 or Estado = 9 or Estado = 20 Order by FechaEstado desc"
...
SQL = "Select * From ConsultaOrdenes Where (Estado = 'Entregado y Cobrado' or Estado = 'Vendido' or Estado = 'Pagado' or Estado = 'Cobrada' or Estado = 'Pago a Cuenta' or Estado = 'Cobro a Cuenta') and FechaEstado = #" & FormatMediumDate(DATE) & "# order by Id"
else
SQL = "Select * From ConsultaOrdenes Where (Estado = 'Entregado y Cobrado' or Estado = 'Vendido' or Estado = 'Pagado' or Estado = 'Cobrada' or Estado = 'Pago a Cuenta' or Estado = 'Cobro a Cuenta') and FechaEstado = #" & FormatMediumDate(Request.QueryString("Fecha")) & "# order by Id"
end if
ObRs.Open  SQL,ObConn
Total = 0
DO WHILE NOT ObRs.Eof
